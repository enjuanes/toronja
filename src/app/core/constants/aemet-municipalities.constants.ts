// Cached from opendata.aemet.es/opendata/api/maestro/municipios on 2026-04-13
// Hacer un script de pnpm par que actualice esto, poner en el comentario que es porque esta llamada satura la api, que tire de la apikey de

export const AEMET_MUNICIPALITIES_MAP: Record<string, string> = {
  '10001': 'Abadía',
  '10002': 'Abertura',
  '10003': 'Acebo',
  '10004': 'Acehúche',
